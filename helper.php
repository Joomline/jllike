...
class PlgJLLikeHelper {
   ...
   * @return string
   */
  public function ShowIn($id, $link = '', $title = '', $image = '', $desc = '', $enable_opengraph = 1) {
...
HTML;
   ...
   * @param $articleText
   */
  public function loadScriptAndStyle($isCategory = 1) {
...
SCRIPT;
  ...
  public function getShareText($metadesc, $introtext, $text) {
